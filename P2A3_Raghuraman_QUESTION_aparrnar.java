 ...
 */
public class P2A3_Raghuraman_QUESTION_aparrnar {
		public static ArrayList <String> words = new ArrayList <String>(); //list of guesswords
		public static ArrayList <String> hints = new ArrayList <String>(); //list of hints for the guesswords
		public static String filename; //filename for the guesswords and hints
		private static int wordIndex; //line at which the word has been found
		/**
		 * Default constructor
		 */
		public P2A3_Raghuraman_QUESTION_aparrnar()
		{
			filename = null;
			words = null;
			hints = null;		
		 ...
		 */
		public P2A3_Raghuraman_QUESTION_aparrnar(String file)
		{
			filename = file;
			wordIndex = -1;
		}
