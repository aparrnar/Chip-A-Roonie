...
public class P2A3_Raghuraman_GAME_aparrnar {

	public String guessWord;
	public String guessHint;
	    ...
	    public int guessIsWrong(P2A2_Raghuraman_PLAYER_aparrnar player[], int playerCounter)
	    {
	        ...
	        if (player[playerCounter].wrongTicks != 5) //player still has guesses left
	        {
	            ...
	            if(player[playerCounter].wrongTicks == 1)
	     ...
	     */
	    public boolean checkBadGuess(Character playerCharGuess, int playerCounter, HashMap< Integer, ArrayList < Character >> charactersEntered)
	    {
	    	if (!Character.isLetter(playerCharGuess)) //player does not enter a valid alphabet
	        {
	            System.out.println("Enter a valid alphabet!");
	            return true;
	        } else if (charactersEntered.get(playerCounter) != null && charactersEntered.get(playerCounter).contains(playerCharGuess)) {
	    ...
	    public String startGame(int numberOfPlayers) {
				...
				return "dummy"; //control never reaches here
	        }
	    
	    public void loadWordAndHint() throws IOException
	    {
	    	Scanner input = new Scanner(System.in);
	    	System.out.println("Enter the filename for the file containing words and hints");
